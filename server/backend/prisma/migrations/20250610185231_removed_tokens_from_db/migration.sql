/*
  ...
  - You are about to drop the column `guacToken` on the `Device` table. All the data in the column will be lost.
  - You are about to drop the column `guacTokenExpiration` on the `Device` table. All the data in the column will be lost.
