/*
  ...
  - You are about to drop the column `vncParams` on the `Device` table. All the data in the column will be lost.
...
INSERT INTO "new_Device" ("approved", "guacSshConnectionId", "guacVncConnectionId", "id", "ip", "lastSeen", "macAddrs", "machineId", "name", "pin", "publicKey", "registeredAt", "sshLocalPort", "sshOn", "sshPort", "sshPrivateKey", "sshPrivateKeyPassphrase", "vncLocalPort", "vncOn", "vncPort") SELECT "approved", "guacSshConnectionId", "guacVncConnectionId", "id", "ip", "lastSeen", "macAddrs", "machineId", "name", "pin", "publicKey", "registeredAt", "sshLocalPort", "sshOn", "sshPort", "sshPrivateKey", "sshPrivateKeyPassphrase", "vncLocalPort", "vncOn", "vncPort" FROM "Device";
DROP TABLE "Device";
